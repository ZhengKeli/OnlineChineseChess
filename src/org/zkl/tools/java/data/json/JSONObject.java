...
package org.zkl.tools.java.data.json;
 ...
 * <ul>
 *   <li>Use <code>get<i>Status</i>()</code> to retrieve a mandatory value. This
 *       fails with a {@code JSONException} if the requested name has no value
 *       or if the value cannot be coerced to the requested type.
 *   <li>Use <code>opt<i>Status</i>()</code> to retrieve an optional value. This
 *       returns a system- or userName-supplied default if the requested name has no
...
public class JSONObject {
     ...
     */
    // Change {@code append) to {@link #append} when append is
    // unhidden.
